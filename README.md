## print("Hello World, I'm Parker!")
**Database Developer** | Automating workflows & building data pipelines
  I build data integration systems and automation tools that make operations across platforms smoother. My work includes:
  <ul>
    <li>Designing scalable SQL databases</li>
    <li>Developing RESTful API pipelines</li>
    <li>Deploying serverless applications with AWS Lambda</li>
  </ul> 

I love experimenting with code and learning new things every day. Whether it’s crafting data pipelines or small automations to make life easier, I put passion into improving processes and workflows.
